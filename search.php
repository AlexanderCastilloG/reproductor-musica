...
<div class="searchContainer">
    <h4>Search for a artist, album or song</h4>
    <input spellcheck="false" type="text" class="searchInput" value="<?php echo $term; ?>" placeholder="Start typing..." onfocus="this.value = this.value">
</div>

<script>

    /*Para deshabilitar el corrector ortográfico de goggle en los inputs=> text - textArea */
    // $("input[type='text'], textarea").attr('spellcheck',false);
    $(".searchInput").focus().val("").val("<?php echo $term ?>");
    // console.log('pepe');
